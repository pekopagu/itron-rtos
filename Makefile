...
OBJECTS := $(BOOT_OBJ) $(KERNEL_OBJ) $(SERIAL_OBJ)

CFLAGS := -target i386-elf -ffreestanding -fno-stack-protector -fno-pic -fno-pie -Wall -Wextra -I.
...
$(KERNEL_OBJ): kernel/kernel.c arch/x86_64/serial.h | dirs
